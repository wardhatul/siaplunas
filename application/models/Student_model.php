...
class Student_model extends CI_Model {
    ...
    function get_class($params = array())
    {
        ...
        if(isset($params['class_address']))
        {
            $this->db->where('class_address', $params['class_address']);
        }
        ...
        $this->db->select('class_id, class_name, class_address');
    ...
    function add_class($data = array()) {
        ...
        if (isset($data['class_address'])) {
            $this->db->set('class_address', $data['class_address']);
        }
